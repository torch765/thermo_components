...
Current status: Phases 0, 1, 2, and 3 are complete. Phase 4 is in progress; the Qt worker bridge, result-list presenter, calculation input collector, warning-banner controller, and composition-table setup/basis/total/row controller have been extracted.
...
- Introduce smaller Qt controller/presenter modules around normalization UI feedback and report actions.
