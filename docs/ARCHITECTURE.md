...
- remaining PyQt widget workflow coordination, including normalization UI feedback
...
| Composition table setup, basis styling, total validation, and row/list mutation | Extracted | `adapters/ui/composition_table.py` |
